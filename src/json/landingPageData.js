...
export const Testimonials = [
  {
    ...
    testimoni:
      "Thanks for babelmendunia, you guys are the best! Keep up the great work!",
    imageUrl: Sasha,
  },
  {
    id: 2,
    ...
    testimoni:
      "I just wanted to let you know that it’s been great working with babelmendunia.",
    imageUrl: Kruger,
  },
  {
    id: 3,
    ...
    testimoni:
      "babelmendunia is so great. Thank you so much for a job well done.",
    imageUrl: Reiner,
  },
];
